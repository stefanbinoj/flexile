...
export default function Terms() {
  return (
    <section className="prose [&_a]:break-all">
      ...
      <p>
        This Terms of Service Agreement ("<strong>Agreement</strong>") is for Customers and Contractors (defined below)
        ("<strong>You</strong>" as applicable), and governs Your use of the Flexile platform (the "
        ...
        Accepting the terms and conditions of this Agreement will allow Customers and Contractors to use the Platform in
        the manner set forth herein. To engage a Contractor (if You are a Customer), or be engaged by a Customer (if You
        are a Contractor), as applicable, to provide Contractor Services (defined below), Customer and Contractor must
        also agree to the terms of a separate independent contractor agreement (the "<strong>IC Agreement</strong>").
      </p>
      ...
      <p>
        ...
        THE USER (AND, IF YOU ARE ENTERING INTO THIS AGREEMENT AS A REPRESENTATIVE, AGENT OR EMPLOYEE THEREOF NAMED AS
        USER, YOU HAVE THE RIGHT TO BIND THAT COMPANY TO THE TERMS OF THIS AGREEMENT). THE TERM "<strong>YOU</strong>"
        REFERS TO THE INDIVIDUAL OR LEGAL ENTITY, AS APPLICABLE, IDENTIFIED AS THE USER WHEN YOU REGISTER. IF YOU DO NOT
        AGREE TO BE BOUND BY THESE TERMS, YOU SHOULD NOT CLICK THE "I ACCEPT" BUTTON.
      </p>
      <ol>
        <li id="jump_1">
          ...
          behalf of either Gumroad or You to the other that has been identified as confidential or that by the nature of
        ...
        <li id="jump_3">
          ...
          to the Services to third parties; (b) modify any documentation, or create any derivative product thereof; (c)
          ...
          information or data regarding other Users without their consent; or (e) use the Services or any information or
          data received through or in connection with the Services in a manner that (i) may infringe or violate the
          intellectual property or other rights of any individual or entity, including without limitation the rights of
          publicity or privacy; (ii) may violate applicable laws or governmental regulations; (iii) is unlawful,
        ...
        <li id="jump_4">
          <strong>RELATIONSHIP WITH GUMROAD. </strong>Gumroad merely makes the Services available to enable Customer and
          Contractor to transact directly with each other. Through the Services, Customer and Contractor are able to
          enter into an agreement between one another for the provision of, and payment for, Contractor Services.
        ...
        <li id="jump_5">
          ...
          <ol>
            <li>
              ...
              with other Users in connection with the Services, and You hereby grant Gumroad a non-exclusive, worldwide,
            ...
            <li>
              ...
              Your Account will be subject to verification, including, but not limited to, validation against
              third-party databases or verification of one or more official government or legal documents that confirm
              Your identity, location, and ability to act on behalf of Your business. You authorize Gumroad, directly or
              through third parties, to make any inquiries necessary to validate Your identity, location, and ownership
              of Your email address or financial accounts, subject to applicable law. When requested, You must timely
              provide Gumroad with complete information about You and Your business, which includes, but is not limited
              to, providing official government or legal documents.
            </li>
            <li>
              <strong>Permitted Users. </strong>By granting any individuals or entities permission under Your Account (a
              "<strong>Permitted User</strong>"), You represent and warrant that (a) the Permitted User is authorized to
              act on Your behalf, and (b) You are fully responsible and liable for any action of any Permitted User and
              any other person who uses the Account. If any such Permitted User violates the terms of this Agreement, it
        ...
        <li id="jump_6">
          ...
          <ol>
            ...
            <li>
              ...
              to You and other Users. You are solely responsible for Your User Content, including the accuracy thereof,
              and for any legal action that may be instituted by other Users or third parties as a result of or in
              connection with Your User Content.
            </li>
            <li>
              <strong>Feedback. </strong>You hereby grant to Gumroad a fully paid, royalty-free, perpetual, irrevocable,
              ...
              non-commercially exploit in any manner (a) any and all feedback, suggestions, or ideas related to the
              Services or Gumroad&rsquo;s products, services, or business provided by You (collectively, "
              <strong>Feedback</strong>") and to sublicense the foregoing rights, in connection with the operation,
              maintenance, and improvement of the Services and/or Gumroad&rsquo;s business and (b) any feedback,
              suggestions, ideas, responses, comments, information, and data, including survey responses, provided by
              You or on Your behalf related to any Contractor Services or other Users ("
              ...
              Gumroad shall not share any Service Assessments with any third parties in a manner that identifies You by
              name.
            </li>
          </ol>
        </li>
        <li id="jump_7">
          ...
          investigate such violations. If, as a result of the investigation, Gumroad believes that criminal activity has
          occurred, Gumroad reserves the right to refer the matter to, and to cooperate with, any and all applicable
        ...
        <li id="jump_8">
          ...
          liability incurred as the result of such interactions. While Gumroad may, in Gumroad&rsquo;s sole discretion,
          help facilitate the resolution of disputes through various programs, Gumroad has no control over and does not
          guarantee the existence, quality, safety or legality of Contractor Services; Customer&rsquo;s ability to
          procure services; Contractor&rsquo;s ability to provide Contractor Services; or that a Customer and Contractor
        ...
        <li id="jump_9">
          ...
          <ol>
            <li>
              ...
              Contractor Services. When You enter into an IC Agreement, You agree to use the Services: (a) if you are a
              Customer, to pay any Flexile Fees You owe under this Agreement and any Contractor Fees You owe under the
              IC Agreement; and (b) if you are a Contractor, to receive any Contractor Fees you are owed under the IC
              Agreement. All Contractor Fees must be paid and received through the Services in accordance with the terms
              of this Agreement and the IC Agreement.
            </li>
            <li>
              ...
              specified by Flexile (with respect to the Flexile Fees), and (b) with Contractor in the IC Agreement (with
              respect to the Contractor Fees), and as set forth herein. Gumroad will remit to Contractor the Contractor
              Fees within thirty (30) days of actually receiving payment from Customer. Gumroad shall not be responsible
              for payment of any amounts not actually received by Gumroad, or for any chargebacks, deductions, errors,
              or other payment disputes or issues, provided that Gumroad reserves the right to offset or deduct amounts
              owed to Gumroad, or for chargebacks, deductions, errors, or other payment issues, from amounts received by
              Gumroad hereunder.
            </li>
            <li>
              <strong>Expenses. </strong>Gumroad shall not be responsible for any expenses incurred by You in connection
              with any Contractor Services. If Customer agrees to reimburse Contractor for expenses incurred ("
              <strong>
                <em>Expenses</em>
              </strong>
              "), such reimbursement will be handled directly between Customer and Contractor in accordance with the
              terms set forth in the applicable IC Agreement; provided that Expenses shall only include amounts actually
              paid by Contractor to third parties for products and services required for Contractor&rsquo;s provision of
              the Contractor Services. All other amounts paid to Contractor shall be considered Contractor Fees and must
              be paid through the Services. Gumroad reserves the right to require You to provide receipts and other
            ...
            <li>
              ...
              Furthermore, Gumroad reserves the right to seek reimbursement from You, and You will reimburse Gumroad, if
              Gumroad (a) suspects fraud or criminal activity associated with any payment; (b) discovers erroneous or
              duplicate transactions; or (c) receives any chargebacks from a payment method.
            </li>
            <li>
              ...
              this Agreement. If Gumroad determines it has a legal obligation to collect Tax from You in connection with
              this Agreement, Gumroad shall collect such Tax in addition to the amounts required under this Agreement.
              If any Services, or payments for any Services, under the Agreement are subject to Tax in any jurisdiction
              and You have not remitted the applicable Tax to Gumroad, You will be responsible for the payment of such
              Tax and any related penalties or interest to the relevant tax authority and will indemnify Gumroad Parties
              for any liability or expense incurred. Upon Gumroad&rsquo;s request, You will provide official receipts
              issued by the appropriate taxing authority, or such other evidence or documents reasonably requested.
            </li>
            <li>
              ...
              workers&rsquo; compensation, disability, unemployment, or other insurance needed, desired, or required by
              law, and that You are not covered by or eligible for any insurance from Gumroad; (c) for determining
              ...
              determining if Gumroad is required by applicable law to withhold any amount of the Contractor Fees and for
              notifying Gumroad of any such requirement and indemnifying Gumroad for any requirement to pay any
              ...
              provide copies of Your tax returns and other documents as may be reasonably requested for purposes of such
              audit, including but not limited to records showing You are engaging in an independent business as
        ...
        <li id="jump_10">
          ...
          <ol>
            <li>
              ...
              Both parties agree that all items of Confidential Information are proprietary to the disclosing party, and
              as between the parties, will remain the sole property of the disclosing party.
            </li>
            <li>
              <strong>Confidentiality Exceptions. </strong>Notwithstanding the foregoing, the provisions of Section 10.1
              will not apply to Confidential Information that (a) is publicly available or in the public domain at the
              time disclosed; (b) is or becomes publicly available or enters the public domain through no fault of the
              recipient; (c) is rightfully communicated to the recipient by persons not bound by confidentiality
              obligations with respect thereto; (d) is already rightfully in the recipient&rsquo;s possession free of
              any confidentiality obligations with respect thereto at the time of disclosure; (e) is independently
              developed by the recipient without use of or reference to the other party&rsquo;s Confidential
              Information; or (f) is approved for release or disclosure by the Disclosing party without restriction.
              Notwithstanding the foregoing, each party may disclose Confidential Information to the limited extent
              required (i) to comply with the order of a court or other governmental body, or as otherwise necessary to
              comply with applicable law, provided that the party making the disclosure pursuant to the order shall
              first have given written notice to the other party (to the extent legally permitted) and made a reasonable
              effort to obtain a protective order; or (ii) to establish a party&rsquo;s rights under this Agreement,
        ...
        <li id="jump_11">
          ...
          services. You may not solicit, advertise for, or contact Contractors for employment, contracting, or any other
          purpose not related to the Services.
        </li>
        <li id="jump_12">
          ...
          <ol>
            <li>
              ...
              compensation Gumroad receives for providing the Services is collected through the Service Fee described in
              this Agreement. Gumroad only receives this Service Fee when a Customer and a Contractor pay and receive
              payment through the Services. Therefore, during the term of this Agreement, You agree to use the Services
              as Your exclusive method to make, or receive, as applicable, all payments for work directly or indirectly
              between You and a Contractor (if You are a Customer), or You and a Customer (if You are a Contractor).
            </li>
            <li>
        ...
        <li id="jump_15">
          ...
          INDIRECT, INCIDENTAL, SPECIAL, OR CONSEQUENTIAL DAMAGES, OR DAMAGES OR COSTS DUE TO LOSS OF PRODUCTION OR USE,
          BUSINESS INTERRUPTION, OR PROCUREMENT OF SUBSTITUTE GOODS OR SERVICES, IN EACH CASE WHETHER OR NOT GUMROAD HAS
          BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES, ARISING OUT OF OR IN CONNECTION WITH THESE TERMS OF SERVICE
          OR ANY COMMUNICATIONS, INTERACTIONS OR MEETINGS WITH OTHER USERS, ON ANY THEORY OF LIABILITY, OR (b) ANY
          AMOUNTS THAT ARE GREATER THAN THE TOTAL AMOUNT PAID TO GUMROAD BY CUSTOMER DURING THE TWELVE-MONTH PERIOD
          PRIOR TO THE ACT, OMISSION OR OCCURRENCE GIVING RISE TO SUCH LIABILITY. THE LIMITATIONS OF DAMAGES SET FORTH
          ABOVE ARE FUNDAMENTAL ELEMENTS OF THE BASIS OF THE BARGAIN BETWEEN GUMROAD AND YOU.
        </li>
        <li id="jump_16">
          ...
          <ol>
            ...
            <li>
              <strong>Termination for Breach. </strong>Either party may terminate this Agreement upon written notice to
              the other party if the other party breaches this Agreement and does not cure such breach within fifteen
              (15) days of receiving notice thereof. Furthermore, without limiting Gumroad&rsquo;s other rights or
              remedies, Gumroad may, but is not obligated to, temporarily or indefinitely revoke access to the Services,
            </li>
            <li>
              <strong>Termination for Convenience. </strong>Gumroad may terminate this Agreement for its convenience at
              any time for any reason or no reason at all by providing You with at least thirty (30) days prior written
              notice.
            </li>
            <li>
              ...
              Contractor(s); and (c) Customer will continue to be obligated to pay any amounts owed under the Agreement.
              Any provisions that by their nature would be expected to survive any termination or expiration of this
            ...
            <li>
              ...
              liability arising from or relating to any notice that it may provide to any User regarding closed account
              status or the reason(s) for the closure<strong>.</strong>
            </li>
          </ol>
        </li>
        <li id="jump_17">
          <strong>RELEASE</strong>. Gumroad expressly disclaims any liability that may arise between Users. Because
          Gumroad is not a party to the actual contracts between Customers and Contractors, in the event that You have a
          dispute with one or more Users, You release Gumroad, its parents, subsidiaries, affiliates, officers,
          ...
          or in any way connected with such disputes. You hereby waive California Civil Code Section 1542, or any
          similar law of any other jurisdiction which states in substance, "A general release does not extend to claims
        ...
        <li id="jump_18">
          <strong>DISPUTE RESOLUTION. </strong>All claims and disputes arising out of or relating to the Agreement will
          be litigated exclusively in the state or federal courts located in San Francisco, CA. This Agreement and any
          action related thereto will be governed and interpreted by and under the laws of the State of California,
        ...
        <li id="jump_20">
          ...
          be null and void. Nothing in this Agreement is intended to or should be construed to create a partnership,
          joint venture, franchisor/franchisee or employer-employee relationship between Gumroad and You. Gumroad shall
